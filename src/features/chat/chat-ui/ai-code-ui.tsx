...
import { AICODESelector } from "./aicode-selector";
import { fetchAIName, fetchLogoData } from "@/features/theme/customise";


interface Prop {
}

export const AICODEUI: FC<Prop> = (props) => {
  ...
  let languageSelection = <AICODESelector
  task={task}
  language={language}
